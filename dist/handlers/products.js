...
var productsTable = new products_1.productTable();
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productsTable.index()];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, newproduct, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, productsTable.create(products)];
            case 1:
                newproduct = _a.sent();
                res.json(newproduct);
                return [3 /*break*/, 3];
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productsTable.show(req.params.id)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                cat = req.query.cat;
                return [4 /*yield*/, productsTable.category(cat)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productsTable["delete"](req.params.id)];
            case 1:
